 <?php
    ...
    foreach ($articles as $article): ?>
     ...
     <div class="modal fade " data-bs-backdrop="static" id="allArticleReviewsModal<?= $article['id'] ?>" tabindex="-1" aria-labelledby="allArticleReviewsModalLabel<?= $article['id'] ?>" aria-hidden="true">
         <div class="modal-dialog modal-xl">
             <div class="modal-content text-light">
                 <div class="modal-header bg-navbar border-none">
                     <h1 class="modal-title fs-5" id="allArticleReviewsModalLabel<?= $article['id'] ?>"></h1>
 ...
 <?php endforeach;
    $allArticleReviewsModal = ob_get_clean();
