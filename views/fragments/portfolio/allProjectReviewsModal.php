 <?php
    ...
    foreach ($projects as $project): ?>
     ...
     <div class="modal fade " data-bs-backdrop="static" id="allProjectReviewsModal<?= $project['id'] ?>" tabindex="-1" aria-labelledby="allProjectReviewsModalLabel<?= $project['id'] ?>" aria-hidden="true">
         <div class="modal-dialog modal-xl">
             <div class="modal-content text-light">
                 <div class="modal-header bg-navbar border-none">
                     <h1 class="modal-title fs-5" id="allProjectReviewsModalLabel<?= $project['id'] ?>"></h1>
                     <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                 </div>
                 <div class="modal-body p-0 bg-darkuielement">
                     <?php
                        // Filtrer les commentaires du par projet
                     ...
                     <div class="d-flex flex-column bg-darkuielement  border-top border-bottom border-lightuielement align-self-center">
                         ...
                         <?php else: ?>
                             <?php
                                // Pour chaque commentaire de chaque project
 ...
 <?php endforeach;
    $allProjectReviewsModal = ob_get_clean();
